...
public class KMeansClusterer<T extends Clusterable> extends KMeansPlusPlusClusterer<T> {
	...
	protected Clusterable centroidOf(final Collection<T> points, final int dimension) {
    	...
    	// FIXME Alterar o modo como calculamos o centróide, a saber:
    	// (1) Considerar a média aritmética de todos, independentemente se a quantidade de avaliações é superior à metade dos itens.
    	// (2) Considerar o valor majoritário.
