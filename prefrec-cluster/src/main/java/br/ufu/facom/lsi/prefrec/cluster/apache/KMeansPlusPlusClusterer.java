...
/*
 * KMeansPlusPlusClusterer modified.
 */
...
/**
 * Modified... Clustering algorithm based on David Arthur and Sergei
 * Vassilvitski k-means++ algorithm.
 * 
 * @param <T>
...
public class KMeansPlusPlusClusterer<T extends Clusterable> extends
	 ...
	 */
	protected List<CentroidCluster<T>> chooseInitialCenters(
